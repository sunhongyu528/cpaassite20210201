    ...
    function showNotice(){
        layer.open({
           ...
           title: "系统公告",
            ...
            btn: ['欢迎使用'],
            moveType: 1,
            content: '<div style="padding:15px 20px; text-align:justify; line-height: 22px; text-indent:2em;border-bottom:1px solid #e2e2e2;"><p class="layui-red">Cpaas网站2.0更新（2021-01-01）</span></p></div>',
